...
\newcommand\NumberOfGroups{44}
\newcommand\TotalHoursOfRecording{734}
\newcommand\TotalNumbersOfDays{139}
\newcommand\NumberOfPeople{13}
\newcommand\NumberOfClips{421106}

\newcommand\FemaleHours{225}
\newcommand\MaleHours{508}
\newcommand\LessThanSixtyFiveHours{226}
\newcommand\LessThanSeventyFiveHours{75}
\newcommand\LessThanEightyFiveHours{298}
\newcommand\MoreThanEightyFiveHours{134}
\newcommand\HenryHours{154}
\newcommand\VictorHours{95}
\newcommand\JulienHours{94}
\newcommand\AnneHours{72}
\newcommand\CharlesHours{64}
\newcommand\IreneHours{60}
\newcommand\FionaHours{42}
\newcommand\MargeHours{41}
\newcommand\PeterHours{38}
\newcommand\RickHours{33}
\newcommand\LukeHours{31}
\newcommand\ErikaHours{8}
\newcommand\AprilHours{3}
