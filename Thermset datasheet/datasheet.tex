...
\newcommand\NumberOfClips{463416}
...
during a sensor recalibration, the number of frames in a clip were be less if a recalibration occurs. We estimate the average fps (frame per second)
